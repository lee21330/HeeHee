...
import com.shinhan.heehee.util.JwtTokenUtil;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	/*
	 * private final UserDetailsService userDetailsService; private final
	 * JwtTokenUtil jwtTokenUtil;
	 * 
	 * String HEADER_STRING = "Authorization"; String TOKEN_PREFIX = "Bearer";
	 * 
	 ...
	 * SimpleGrantedAuthority("ROLE_ADMIN"))); UsernamePasswordAuthenticationToken
