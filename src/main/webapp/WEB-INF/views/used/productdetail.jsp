				...
				<div class="product-details">
					...
					<c:if test="${userId == info.id && info.proStatus != '예약중'}">
						<div class="button-container">
							<button onclick="location.href='${path}/sell/productmodify/${info.productSeq}'" style="cursor: pointer">물품정보 수정</button>
					...
					<c:if test="${userId != info.id && info.proStatus == '예약중'}">
						<div class="button-container">
							<button loginUserId="${userId}" sellerId = "${info.id}" sellSeq = "${info.productSeq}" id="gochat" style="cursor: pointer">판매자와 채팅하기</button>
						</div>
					</c:if>
