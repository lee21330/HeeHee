	...
	<div class="mypage_container">
		<div class="top">
			<div class="profileImg">
				<img src="https://sh-heehee-bucket.s3.ap-northeast-2.amazonaws.com/images/mypage/profile_test.jpg">
			</div>
			<div class="profile">
				...
				<textarea class="self-intro">보노보노를 원하신다면 저를 찾아주세요!</textarea>
			...
			<div class="rating">
				<p>평점</p>
				<div class="ratingImg">
					<img src="${path}/resources/images/star0.png"> <img
						src="${path}/resources/images/star0.png"> <img
						src="${path}/resources/images/star0.png"> <img
						src="${path}/resources/images/star0.png"> <img
						src="${path}/resources/images/star0.png">
				</div>
			</div>
			<div class="account">
				<p class=>내 계좌</p>
