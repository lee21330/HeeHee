...
<link rel="stylesheet"
	href="${path}/resources/css/proStatusModifyModal.css">
...
<body>
			...
			$(".stars")
					.on(
							...
							function(e) {
								...
								var starId = parseInt(this.id.replace('rate',
										''), 10);
								$(".stars")
										.each(
												function(index) {
													...
													if (currentId <= starId) {
														...
														$(this)
																.attr(
																		"src",
																		"https://sh-heehee-bucket.s3.ap-northeast-2.amazonaws.com/images/sell/star0.png");
													}
												});
							});
								...
								function(index) {
									...
									if (starNum <= Math.floor(selectedRating)) {
										$(this)
												.attr(
														"src",
														"https://sh-heehee-bucket.s3.ap-northeast-2.amazonaws.com/images/sell/star1.png");
									} else if (starNum - 0.5 === selectedRating) {
										$(this)
												.attr(
														"src",
														"https://sh-heehee-bucket.s3.ap-northeast-2.amazonaws.com/images/sell/star05.png");
									} else {
										$(this)
												.attr(
														"src",
	...
	<div class="rModal" id="aModal">
		<div class="rModal_body">
			...
			<div id="star_wrap">
				<img class="stars" id="rate1"
					src="https://sh-heehee-bucket.s3.ap-northeast-2.amazonaws.com/images/sell/star0.png">
				<img class="stars" id="rate2"
					src="https://sh-heehee-bucket.s3.ap-northeast-2.amazonaws.com/images/sell/star0.png">
				<img class="stars" id="rate3"
					src="https://sh-heehee-bucket.s3.ap-northeast-2.amazonaws.com/images/sell/star0.png">
				<img class="stars" id="rate4"
					src="https://sh-heehee-bucket.s3.ap-northeast-2.amazonaws.com/images/sell/star0.png">
				<img class="stars" id="rate5"
					src="https://sh-heehee-bucket.s3.ap-northeast-2.amazonaws.com/images/sell/star0.png">
			</div>
			<input type="hidden" id="ratingInput"> 
			<input type="hidden" id="ratingProdSeq" value="${saleDetail.productSeq}"> 
			<input type="hidden" id="ratingId" value="${saleDetail.id}">
			<div class="rate_wrap">
